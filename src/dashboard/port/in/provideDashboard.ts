...
export type ReadUserPerformanceSummaryWorkflow = (
...
export type MapPerformanceSummaryList = (
    metrics: PerformanceMetric[],
    userId: UserId,
) => Promise<ProblemSolvingProfiles[]>; // TODO Bad signature, userId must be removed as well as Promise
